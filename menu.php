...
$result = mysqli_query($mysqli, "SELECT * from contas where id and `email` = '$email'");
?>
	...
	<table width='100%' border=0>
		...
		<?php
		  if($res = mysqli_fetch_assoc($result)){
			...
			<a href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Tem certeza que deseja deletar sua conta?')\">Deletar</a></td>";
      }
		?>
	</table>
  <br><br>
  <a href="logout.php"><button type="button" class="botao botao-com-animacao">Sair</button></a><br>
  </div><br><br><br><br>
</div>
</div>
</body>
